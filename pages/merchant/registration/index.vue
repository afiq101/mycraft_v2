...
<template>
    ...
    >
      <template #contactinformation>
        ...
        <FormKit
          ...
          help="Enter your business contact number"
      ...
      <template #addressregistration>
        <rs-card class="p-4">
          ...
          <div class="p-1">
            <FormKit
              ...
              help="Unit No, Floor, Street Name/Building Name"
        ...
        <rs-card class="p-4 mt-4">
          ...
          <div class="flex items-center mb-4">
            <input
              type="checkbox"
              v-model="useWarehouseAddressForReturn"
            />
            <label class="ml-2">Use Warehouse Address</label>
          </div>
          <div v-if="!useWarehouseAddressForReturn">
            <FormKit
              type="text"
              label="Detailed Address"
              help="Unit No, Floor, Street Name/Building Name"
        ...
        <rs-card class="p-4 mt-4">
          ...
          <div class="flex items-center mb-4">
            <input
              type="checkbox"
              v-model="useWarehouseAddressForBusiness"
            />
            <label class="ml-2">Use Warehouse Address</label>
          </div>
          <div v-if="!useWarehouseAddressForBusiness">
            <FormKit
              type="text"
              label="Detailed Address"
              help="Unit No, Floor, Street Name/Building Name"
  ...
  <div>
    ...
    <div v-if="isIndividualSeller">
      ...
      <!-- Personal ID Card -->
      <rs-card class="p-4">
        <h4 class="mb-4">Upload Personal ID Document</h4>
        <FormKit
        type="select"
        label="Document Type"
      ...
      />
        ...
        <FormKit
          type="text"
          label="Registered ID No."
          v-model="registeredIdNo"
          
          validation-visibility="dirty"
        />

        <!-- Conditional Front Image Upload -->
        <div v-if="showFrontImageUpload">
          <FormKit
            type="file"
            label="Front View of ID Document"
            v-model="frontImage"
        ...
        <!-- Conditional Back Image Upload -->
        <div v-if="showBackImageUpload">
          <FormKit
            type="file"
            label="Back View of ID Document"
            v-model="backImage"
    ...
    <div v-if="isCompany">
      ...
      <FormKit
        type="text"
        label="Malaysia Standard Industry Classification (MSIC)"
        v-model="sstRegistrationNumber"
      />
        </rs-card>
    </div>

          <!-- SST Registration Card -->
          <rs-card class="p-4 mt-4">
      <h4>SST Registration</h4>
      <div class="flex items-center mb-4">
      <input
        type="checkbox"
        v-model="isSSTRegistered"
      />
      <label class="ml-2">Registered for SST</label>
      </div>
      <div v-if="isSSTRegistered">
      <FormKit
        type="text"
      ...
      <div class="mb-4">
        <FormKit
            type="file"
            label="SST Registration Number Certificate"
            v-model="sstCert"
      ...
      <!-- TNI Identification Number Card -->
      <rs-card class="p-4 mt-4">
      ...
      <div class="mb-4">
        <FormKit
            type="file"
            label="Official Document with TIN Number"
            v-model="sstCert"
