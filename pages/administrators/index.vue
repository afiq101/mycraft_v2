...
const fetchAdmins = async () => {
  ...
  setTimeout(() => {
    admins.value = [
      { id: 1, name: 'John Doe', type: 'Super Admin', status: 'Active', role: 'Full Access', lastSeen: '2023-04-01 09:30:00' },
      { id: 2, name: 'Jane Smith', type: 'Administrator', status: 'Active', role: 'Limited Access', lastSeen: '2023-04-02 14:45:00' },
      { id: 3, name: 'Bob Johnson', type: 'Sub Account Admin', status: 'Inactive', role: 'Read Only', lastSeen: '2023-03-30 11:20:00' },
    ];
