  ...
  <div class="space-y-8">
    ...
    <div class="relative w-64">
      ...
      >
        ...
        <option v-for="(data, index) in orderStatuses" :key="index" :value="data.code">
          {{ data.label }}
        </option>
      </select>
    </div>
    ...
    <div class="my-5 bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
            ...
            <tr v-for="(data, index) in paginatedOrders" :key="index">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span
                  :class="{
                    ...
                    'bg-indigo-100 text-indigo-800': data.status === 'delivered',
              ...
              >
                <div class="flex gap-2">
                  <div class="cursor-pointer" @click="navigateToDetail(data.id)">
                    <Icon
...
const filteredOrders = computed(() => {
  let filtered = orders.value.filter((order) => {
    return (
      ...
      (!filter.value || order.customer.toLowerCase().includes(filter.value.toLowerCase()))
    );
  });
  ...
  if (selectedDateFilter.value === "today") {
    ...
    filtered = filtered.filter((order) => {
      ...
      return orderMonth >= monthRange.value.start && orderMonth <= monthRange.value.end;
    });
  }
